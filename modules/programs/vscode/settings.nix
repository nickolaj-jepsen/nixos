{
  flake.aspectTags.vscode-settings = ["gui-dev"];
  flake.modules.homeManager.vscode-settings = {
    config,
    lib,
    pkgs,
    ...
        ...
        userSettings = lib.mkMerge [
          {
            ...
            "remote.SSH.remotePlatform" = lib.mapAttrs (_name: _value: "linux") config.programs.ssh.settings;
