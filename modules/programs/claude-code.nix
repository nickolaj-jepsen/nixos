  ...
  config = {
    fireproof.home-manager = {
      programs.claude-code.memory.text = ''
        This is a NixOS system. Usually build from a flake based config in ~/nixosæ.
        - The default shell is fish. Make sure to only use fish supported syntax.
        - If a command is not found, try [comma](https://github.com/nix-community/comma) before giving up. eg (`, <command>` (e.g. `, pstree`, `, ncdu .`)
