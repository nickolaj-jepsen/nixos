_: {
  perSystem = {
    ...
    sha256Map = {
      ...
      "linux-arm64" = "sha256-G3Kl90nWUI5hZKAzANQVx2J//vQ5GL5FtTegqPnCeqg=";
      "darwin-amd64" = "sha256-PdTEOh5jE6HCfPWoIZGBsB9cYPvTrTRwpie4LUAIjFY=";
      "darwin-arm64" = "sha256-z3+FbGLLSTG3zcriMhW+02HkLqInyxZ6aI95fe/59To=";
    };
