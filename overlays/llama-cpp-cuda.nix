...
#
# Pinned ahead of nixpkgs (b10837, Sep 7): Qwen3.8 MTP speculative
...
# over a hundred commits. Drop the overrideAttrs once nixpkgs catches up past b10837.
{
  inputs,
  lib,
  ...
      ...
      in
        (pkgs.llama-cpp.override {cudaSupport = true;}).overrideAttrs (_old: {
          ...
          src = pkgs.fetchFromGitHub {
            ...
            repo = "llama.cpp";
            tag = "b10837";
            hash = "sha256-nz+L04Klqb803aYa3haZhp1L+hua103JhxRqhz33jYo=";
          };
        });
    };
}
