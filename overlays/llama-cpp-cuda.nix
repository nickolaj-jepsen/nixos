...
#
# Pinned ahead of nixpkgs (b10997, Sep 16): Qwen3.8 MTP speculative
...
# trails this pin. Drop the overrideAttrs once nixpkgs catches up past b10997.
{
  inputs,
  lib,
  ...
      ...
      in
        (pkgs.llama-cpp.override {cudaSupport = true;}).overrideAttrs (_old: {
          ...
          src = pkgs.fetchFromGitHub {
            ...
            repo = "llama.cpp";
            tag = "b10997";
            hash = "sha256-0E6U1Kw8frOfwYskm+XdqAQ2KAU+LrNBWKn/UOm5DsM=";
          };
        });
    };
}
